...
//-- Tags weren't matching
//-- The tags for receive and send weren¿t matching. Those were corrected by matching the receive tag for task 0 to rank+1 and for task1 to rank-1
